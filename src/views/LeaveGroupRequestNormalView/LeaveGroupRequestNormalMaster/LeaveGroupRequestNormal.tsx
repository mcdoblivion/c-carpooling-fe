...
import useLeaveGroupRequestNormal from "./LeaveGroupRequestNormalHook";

/* end individual import */

function LeaveGroupRequestNormal() {
  const {
    filter,
    list,
    count,
...
export default LeaveGroupRequestNormal;
